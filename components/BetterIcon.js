...
const BetterIcon = ({ children }) => {
  return (
    <div className="w-12 h-12 inline-flex items-center justify-center rounded-full bg-primary/20 text-primary ring ring-primary/30 ring-offset-base-100 ring-offset-2 hover:scale-110 transition-transform">
      {children}
    </div>
  );
};
