...
const ButtonPopover = () => {
  return (
    <Popover className="relative z-10">
      {({ open }) => (
        <>
          <Popover.Button className="btn btn-ghost font-mono border border-primary/30 hover:border-primary/50">
            POPOVER MENU
            <svg
          ...
          >
            <Popover.Panel className="absolute left-0 z-10 mt-3 w-screen max-w-full sm:max-w-sm lg:max-w-2xl transform">
              <div className="overflow-hidden rounded-lg cyber-card shadow-xl border-2 border-primary/30">
                <div className="relative grid gap-4 bg-base-100 p-4 lg:grid-cols-2">
                  <div className="text-sm flex items-center gap-3 p-2 cursor-pointer hover:bg-primary/10 hover:border-primary/30 border border-transparent rounded-lg duration-200">
